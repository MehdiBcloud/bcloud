...
describe('Payzone', () => {
    ...
    const dataCredit = require('../../fixtures/Credit card (PayPal).json');
    ...
    it('Credit Card Infos',()=>{
        cy.wait(500)
        cy.get('#c2pCardHolderName').type('Mehdi Mehdi')
        cy.get('#c2pCardNumber').type('4111111111111111', { sensitive: true })
        cy.get('#c2pCardExpireDateShort').type('10/24')
        cy.get('#c2pCardSecurityCode').type('000', { sensitive: true })
        cy.get('#c2pSubmitButtonContainer').click()
    })
